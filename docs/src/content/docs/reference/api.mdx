...
> `StyleDictionary.registerSorter(sorter) ⇒ StyleDictionary`

Add a custom [sorter](/reference/hooks/sorters) to the Style Dictionary.

| Param         | Type       | Description                                                                                                                     |
| ------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Sorter        | `Object`   |                                                                                                                                 |
| Sorter.name   | `string`   | Name of the sorter to be referenced in format options                                                                           |
| Sorter.sorter | `function` | Comparator function that takes two tokens and returns a number. Follows the standard JavaScript `Array.sort` comparator pattern |

Example:

```js
StyleDictionary.registerSorter({
  name: 'by-type',
  sorter: (a, b) => {
